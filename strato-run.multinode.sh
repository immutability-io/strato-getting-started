...
then
    export NODE_NAME=p2pnode3.eastus.cloudapp.azure.com
    export BLOC_URL=http://p2pnode3.eastus.cloudapp.azure.com/bloc/v2.1
    export BLOC_DOC_URL=http://p2pnode3.eastus.cloudapp.azure.com/docs/?url=/bloc/v2.1/swagger.json
    export STRATO_URL=http://p2pnode3.eastus.cloudapp.azure.com/strato-api/eth/v1.2
    export STRATO_DOC_URL=http://p2pnode3.eastus.cloudapp.azure.com/docs/?url=/strato-api/eth/v1.2/swagger.json
